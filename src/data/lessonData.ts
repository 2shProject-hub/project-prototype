...
export const LEARNING_FLOW = [
  ...
  { screenId: 'grammar-complete', label: '완료-8. 문법 학습 완료', step: 32 },
  { screenId: 'completion-celebration-grammar', label: '완료-2. 완료 축하 화면(문법)', step: 33 },
  // 평가 인트로
  { screenId: 'intro-eval', label: '4-1-3. 학습 소개(실전 평가)', step: 34 },
  // 대화 실전
  { screenId: 'video-ai-tutor', label: '13-1. 영상과 AI튜터', step: 35 },
  { screenId: 'conversation-preview', label: '대화-1. 전체 대화 듣기', step: 36 },
  { screenId: 'completion-practice-listen', label: '완료-4. 실전 듣기 완료', step: 37 },
  { screenId: 'conversation-shadowing', label: '대화-2. 따라 말하기', step: 38 },
  { screenId: 'completion-practice-read', label: '완료-5. 실전 읽기 완료', step: 39 },
  { screenId: 'dialogue-listen-write', label: '대화-3. 실전 쓰기', step: 40 },
  { screenId: 'completion-practice-write', label: '완료-6. 실전 쓰기 완료', step: 41 },
  { screenId: 'practice-check', label: '대화-4. 실전 확인', step: 42 },
  { screenId: 'completion-practice-check', label: '완료-7. 실전 확인 완료', step: 43 },
  { screenId: 'completion-celebration-class', label: '완료-3. 완료 축하 화면(수업)', step: 44 },
  { screenId: 'learning-report', label: '24. 학습 리포트', step: 45 },
];
