...
const BUBBLE_LINES = [
  'Hôm nay chúng mình sẽ cùng học từ vựng và cách nói về tên nước, quốc tịch nhé.',
  'Sau đó, chúng ta sẽ thử dùng tiếng Hàn để tự giới thiệu tên và quốc tịch của bản thân.',
  'Nhưng trước tiên, để xem các bạn còn nhớ kiến thức buổi trước không, chúng mình hãy cùng giải bài tập để kiểm tra từng câu một nha!',
];
