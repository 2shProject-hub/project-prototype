...
export function CompletionCelebrationGrammarStage({
  title = '훌륭해요!',
  titleVi = 'Tuyệt vời!',
  description = '문법 학습을 모두 완료했습니다.\n이제 실전 평가로 넘어가 볼까요?',
  descriptionVi = 'Bạn đã hoàn thành phần học ngữ pháp.\nBây giờ, chúng ta cùng làm bài đánh giá thực chiến nhé!',
  nextButtonText = '확인',
